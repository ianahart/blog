    ...
    >
      ...
      <ul>
        <li>
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to ianblog.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to ianblog, accessible from{' '}
          <a href="https://www.ianhartblog.herokuapp.com" rel="noreferrer" target="_blank">
            https://www.ianhartblog.herokuapp.com
          </a>
        </li>
        <li>
      ...
      <ul>
        <li>By email: boardreserve@gmail.com</li>
      </ul>
    </Box>
  );
};
