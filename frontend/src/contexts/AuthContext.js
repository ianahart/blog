...
const AuthContextProvider = (props) => {
    const userReset = {adminExists: false, isTempVerified: false, accessToken: null, userId: null, authenticated: false, firstName: null, lastName: null, email: null, avatarUrl: null};
